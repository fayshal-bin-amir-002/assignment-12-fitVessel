                    ...
                    <div className="w-full p-8 lg:w-1/2">
                        ...
                        <form onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <div className="mt-4 relative">
                                <Input {...register("password")} type={showPass ? 'text' : 'password'} name="password" variant="standard" label="Password" placeholder="Type your password..." className="relative" required />
