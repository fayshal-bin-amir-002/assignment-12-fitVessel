                                ...
                                <div className="flex flex-col justify-between px-4 py-6 bg-white border border-gray-400 text">
                                    ...
                                    <div className="flex items-center justify-between mt-3">
                                        ...
                                        <div className="flex gap-2 justify-end">
                                            ...
                                            <button onClick={() => handleVote('like', blog._id, user?.email)} className="py-1.5 px-3 hover:text-green-600 hover:scale-105 hover:shadow text-center border rounded-md border-gray-400 h-8 text-sm flex items-center gap-1 lg:gap-2">
                                            ...
                                            <button onClick={() => handleVote('dislike', blog._id, user?.email)} className="py-1.5 px-3 hover:text-red-600 hover:scale-105 hover:shadow text-center border  rounded-md border-gray-400 h-8 text-sm flex items-center gap-1 lg:gap-2">
                                                <svg className="w-4 h-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
